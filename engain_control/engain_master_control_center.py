...
def run_master_board() -> bool:
    ...
    required_boards = [
        ...
        ("tier1.engainos.engainos_control_center", "EngAInOS"),
        ("tier2.godotsim.godotsim_control_center", "GodotSim"),
        ("tier2.engionality.engionality_control_center", "Engionality"),
