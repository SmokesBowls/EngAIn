...
class ZWEditorGUI:
    ...
    def on_editor_event(self, event=None):
        """Handle cursor movement and key releases"""
        self.update_cursor_position()
        self.check_changes()

    def on_editor_modified(self, event=None):
        """Handle text modifications (including paste)"""
