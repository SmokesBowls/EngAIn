...
export type ProviderType = 'anthropic' | 'azure' | 'bedrock' | 'cerebras' | 'chatgpt_oauth' | 'deepseek' | 'google_ai' | 'google_vertex' | 'groq' | 'hugging-face' | 'letta' | 'lmstudio_openai' | 'minimax' | 'mistral' | 'ollama' | 'openai' | 'together' | 'vllm' | 'sglang' | 'openrouter' | 'xai' | 'zai';
