...
Snapshot-in â†’ path-out architecture:
...
def find_path(
    ...
    came_from = {}  # cell â†’ parent cell
    g_score = {start_cell: 0.0}  # cell â†’ cost from start
    f_score = {start_cell: euclidean_distance(start_cell, goal_cell)}  # cell â†’ estimated total cost
...
if __name__ == "__main__":
    ...
    print("âœ… navigation_mr kernel tests complete")
