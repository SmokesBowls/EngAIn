...
## 2024-05-20 - [In-App Dirty State Indicators]
**Learning:** Users often overlook OS window titles for unsaved changes; displaying the dirty state directly in an in-app file label provides more immediate visibility.
**Action:** Always ensure critical document states (like unsaved changes) are reflected within the app's immediate UI, rather than relying solely on window chrome.
