...
## 2024-06-25 - In-App Dirty State Indicators
...
**Action:** When implementing dirty tracking, mirror the OS title indicators in a prominent in-app status label, checking `hasattr` to avoid initialization errors.
