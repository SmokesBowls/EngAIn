...
## 2024-06-03 - Add Select All Shortcut to Tkinter Text Widgets
**Learning:** Tkinter's `Text` and `ScrolledText` widgets lack consistent cross-platform built-in support for the "Select All" shortcut.
