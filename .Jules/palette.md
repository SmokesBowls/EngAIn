...
## 2024-05-11 - Add Consistent Select All Shortcut in Tkinter
**Learning:** Tkinter's `Text` and `ScrolledText` widgets lack consistent cross-platform support for the 'Select All' shortcut. Relying on default bindings leads to broken text editing UX.
