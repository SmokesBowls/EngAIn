...
# Trixel artwork endpoints were removed 2026-07-16: legacy 2D trixel is evicted from
# EngAIn until trixel3.2d lands. Artwork re-entry must route through the single
# trixel32d handshake (see gates/gate_trixel32d_handshake.py and HANDSHAKES.md §7).
