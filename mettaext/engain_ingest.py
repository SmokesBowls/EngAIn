...
Usage:
  ...
  # Load existing ZONJ files into runtime
  python3 engain_ingest.py --load-zonj ./game_scenes/ --out ./loaded/ --runtime http://localhost:8080
...
def post_scene(runtime_url: str, scene: dict, scene_id: str) -> tuple[bool, str]:
    """POST a ZONJ scene dict to the runtime's /scene/load endpoint."""
    url = runtime_url.rstrip("/") + "/scene/load"
...
""",
    ...
    parser.add_argument("--runtime",      default=None,  help="Runtime URL to POST scenes to, e.g. http://localhost:8080")
