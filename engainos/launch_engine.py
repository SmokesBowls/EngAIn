...
def run_invariants_check():
    ...
    print("  [1/7] Bridge runtime files...")
    ...
    for f in required_files:
        assert_invariant((BRIDGE / f).exists(), f"{f} missing", critical=True)
    print("  ✓ All bridge runtime files present (Validated)")
    ...
    try:
        from bridgeroom.scene_server import start_scene_server
        import bridgeroom.godot_adapter as godot_adapter
...
from aproom.ap_engine import ZWAPEngine, StateProvider
from aproom.ap_runtime import APRuntimeIntegration
