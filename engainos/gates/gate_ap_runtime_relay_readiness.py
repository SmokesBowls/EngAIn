...
def gate_runtime_imports_fenced_zw_engine() -> GateResult:
    ...
    required = [
        "from engainos.core.ap_zw_engine import",
        "ZWAPEngine",
        "StateProvider",
        "APInternalRule",
    ]
    ...
    forbidden = [
        ...
        "from engainos.core.ap_engine import ZWAPEngine",
    ]
    ...
    return GateResult(
        ...
        status="TRUE" if passed else "FALSE",
        message=(
            "AP runtime imports fenced ZW engine from engainos.core.ap_zw_engine."
            if passed
