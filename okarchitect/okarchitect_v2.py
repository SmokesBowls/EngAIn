...
class OKArchitect:
        ...
        self.members = {
            "Reasoner": ArchitectMember(
                ...
                personality=self._with_context(
                    "You are the big-picture strategic architect. You think about overall "
                    "system design, architectural decisions, and high-level patterns. You "
                    "understand trade-offs and guide the team toward coherent solutions."
                )
            ),
            "Validator": ArchitectMember(
                ...
                personality=self._with_context(
                    "You are the fast validator. You catch errors quickly, perform sanity "
                    "checks, and prevent runaway logic. You're the safety net that keeps "
                    "the council honest and grounded."
                )
            ),
            "EngineerA": ArchitectMember(
                ...
                personality=self._with_context(
                    "You are the main systems engineer. You focus on practical implementation, "
                    "Python correctness, and making things work in real code. You're the "
    ...
    def _with_context(self, base_personality: str) -> str:
        ...
        return (
            ...
            "---\n\n"
            f"{base_personality}\n\n"
            "When answering, reference the EngAIn subsystems and follow the 3-layer pattern shown in the examples."
        )
    ...
    def consult_member(self, member: ArchitectMember, prompt: str, 
        ...
        # Build full prompt with personality + context + history
        full_prompt = f"{member.personality}\n\n"
