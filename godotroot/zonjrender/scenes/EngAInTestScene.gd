...
@export var vault_root: String = "/run/media/mytruelove/storage1/pop/obsidian/obsidianburdenNov25"
@export var manifest_path: String = "/run/media/mytruelove/storage1/pop/obsidian/obsidianburdenNov25/vault.manifest.json"
